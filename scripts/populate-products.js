...
const { createProduct } = require('../src/lib/api/products');
const { createSubscriptionPlan, createSubscriptionPrice } = require('../src/lib/api/subscriptions');
 ...
 */
async function createOneTimePrices(products) {
 ...
 */
async function createSubscriptionPrices(subscriptionPlans) {
